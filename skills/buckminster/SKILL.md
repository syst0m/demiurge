...
| `~/Documents/code/demiurge/research/RESEARCH.md` | The shared snapshot. You maintain it; Marcus consumes it. |
...
`~/Documents/code/demiurge/scripts/sync-skills.sh` so Marcus picks up the new copy.
