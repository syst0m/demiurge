#!/usr/bin/env python3
"""Benchmark metrics and comparative telemetry engine for DeepSWE evaluations.
...
- Turn economy: Mean turns to valid solution
...
def render_markdown_report(comparison: BenchmarkComparison) -> str:
    ...
    return f"""# DeepSWE Comparative Evaluation Report
